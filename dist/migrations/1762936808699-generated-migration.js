...
exports.GeneratedMigration1762936808699 = void 0;
class GeneratedMigration1762936808699 {
    constructor() {
        this.name = 'GeneratedMigration1762936808699';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "student" ("id" SERIAL NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_3d8016e1cb58429474a3c041904" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "instructor" ("id" SERIAL NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_ccc0348eefb581ca002c05ef2f3" PRIMARY KEY ("id"))`);
...
exports.GeneratedMigration1762936808699 = GeneratedMigration1762936808699;
//# sourceMappingURL=1762936808699-generated-migration.js.map